...
def seal_passthrough_authorization_code(
    upstream_code: str, client_id: str, client_secret: str | None, mcp_server_id: str
) -> str:
...
async def mint_ephemeral_dcr_client(request: Request, mcp_server: MCPServer) -> EphemeralDcrClient | None:
    ...
    async with lock:
        ...
        minted = EphemeralDcrClient(client_id=registration.client_id, client_secret=registration.client_secret)
